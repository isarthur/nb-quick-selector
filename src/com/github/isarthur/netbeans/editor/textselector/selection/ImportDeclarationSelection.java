 ...
 */
public class ImportDeclarationSelection extends Selection {

    public ImportDeclarationSelection(JTextComponent editor, TokenSequence<?> ts, int selectionStart, int selectionEnd,
