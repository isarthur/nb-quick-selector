 ...
 */
public class PackageDeclarationSelection extends Selection {

    public PackageDeclarationSelection(JTextComponent editor, TokenSequence<?> ts, int selectionStart, int selectionEnd,
